...
# plt.plot(times)
# plt.title("Runtime Analysis of Selection Sort - caroflow")
# plt.show()

# times = evaluate_runtime("insertion_sort", START_SIZE, END_SIZE)
# plt.plot(times)
# plt.title("Runtime Analysis of Insertion Sort - caroflow")
# plt.show()

usage = evaluate_memory_usage("selection_sort", START_SIZE, END_SIZE)
plt.plot(usage)
plt.title("Memory Usage Analysis of Selection Sort - caroflow")
plt.show()
	 
usage = evaluate_memory_usage("insertion_sort", START_SIZE, END_SIZE)
plt.plot(usage)
plt.title("Memory Usage Analysis of Insertion Sort - caroflow")
plt.show()
